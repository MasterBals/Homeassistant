"""Chur Kultur custom integration."""
...
FRONTEND_URL = "/chur_kultur_static"
CARD_URL = f"{FRONTEND_URL}/chur-kultur-card.js?v=1.0.0"
DATA_FRONTEND_REGISTERED = "frontend_registered"


async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    """Set up Chur Kultur from a config entry."""
    ...
    coordinator = ChurKulturCoordinator(hass, entry)
